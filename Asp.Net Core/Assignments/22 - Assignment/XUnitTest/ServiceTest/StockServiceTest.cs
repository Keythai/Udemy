...
namespace XUnitTest
{
    public class StockServiceTest
    {
        ...
        public async Task CreateBuyOrder_ValidBuyOrderRequest()
        {
            ...
            //Act
            BuyOrderResponse buyOrderResponseActual = await _stockService.CreateBuyOrder(buyOrderRequest);
        ...
        public async Task CreateSellOrder_ValidBuyOrderRequest()
        {
            ...
            //Act
            SellOrderResponse sellOrderResponseActual = await _stockService.CreateSellOrder(sellOrderRequest);
